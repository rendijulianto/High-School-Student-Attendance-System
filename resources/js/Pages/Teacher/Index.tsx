...
export default function Teacher(
    { auth, teachers, search, totalData, flash }: PageProps,
    props: any
) {
                    ...
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="relative overflow-x-auto shadow-md sm:rounded-lg px-4 py-4">
                                ...
                                <Pagination
                                    perPage={teachers.pagination.perPage}
                                    currentPage={
                                        teachers.pagination.currentPage
                                    }
                                    totalData={teachers.pagination.total}
                                    lastPage={teachers.pagination.lastPage}
                                    params={"page"}
                                />
                            </div>
                        </div>
